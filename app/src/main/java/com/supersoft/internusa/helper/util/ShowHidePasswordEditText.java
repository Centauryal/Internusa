...
public class ShowHidePasswordEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_custom_show);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_custom_hide);
            ...
            visibilityIndicatorShow = R.drawable.ic_custom_show;
            visibilityIndicatorHide = R.drawable.ic_custom_hide;
