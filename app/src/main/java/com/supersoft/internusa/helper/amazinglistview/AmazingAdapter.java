package com.supersoft.internusa.helper.amazinglistview;
...
public abstract class AmazingAdapter extends BaseAdapter implements SectionIndexer, OnScrollListener {
    ...
    public void startPage(int page){this.page = page;}
    /**
     ...
     * and call {@link AmazingListView()} if there is no more pages.
     *
