package com.supersoft.internusa.helper.bluetooth;
...
public class BluetoothState {
    ...
    //bt
    public static final int BT_CONNECT_DEV_SUCCESS = 900;
    public static final int BT_SERVICE_OPEN = 901;
    public static final int BT_CONNECT_DEV_FAILED = 902;
    public static final int BT_FIND_ADDRESS = 903;
    public static final int BT_PRINT_FINISH = 904;
}
