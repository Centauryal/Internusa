...
import com.supersoft.internusa.helper.uploadservice.schemehandlers.SchemeHandler;
import com.supersoft.internusa.helper.uploadservice.schemehandlers.SchemeHandlerFactory;
...
public class UploadFile implements Parcelable {
    ...
    public UploadFile(String path) throws FileNotFoundException {
        ...
        try {
            ...
            //Log.e("Uploadfile", exc.getMessage());
