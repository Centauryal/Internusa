package com.supersoft.internusa.helper.exception;
                ...
                builder.setPositiveButton("Report",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,int which) {
                                ...
                                StringBuilder body = new StringBuilder(context.getResources().getString(R.string.app_name));
                                body.append('\n').append('\n');
                                body.append(errorContent).append('\n').append('\n');

                                sendIntent.putExtra(Intent.EXTRA_EMAIL,new String[] { "imam.mhm21@gmail.com" });
