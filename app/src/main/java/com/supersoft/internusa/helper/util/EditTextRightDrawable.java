...
public class EditTextRightDrawable extends android.support.v7.widget.AppCompatEditText {
    ...
    public EditTextRightDrawable(Context context, AttributeSet attrs) {
        super(context, attrs);
        // this Contructure required when you are using this view in xml
    }

    public EditTextRightDrawable(Context context, AttributeSet attrs, int defStyle) {
