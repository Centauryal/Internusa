...
public class MapFragmentActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private Bitmap getMarkerBitmapFromView(String uriAvatar, String address) {
        //@DrawableRes int resId
        View customMarkerView = ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.view_custom_marker, null);
        ImageView markerImageView = customMarkerView.findViewById(R.id.profile_image);
        TextView markerAddress = customMarkerView.findViewById(R.id.txtAddress);
        //markerImageView.setImageResource(resId);
        Constant.loadDefaulSlideImage(this,uriAvatar, markerImageView);
    ...
    public void onLocationChanged(Location location) {
        ...
        mCurrLocationMarker = mMap.addMarker(new MarkerOptions()
                .position(latLng)
                .icon(BitmapDescriptorFactory.fromBitmap(getMarkerBitmapFromView(_pf.avatar,alamat))));
        ...
        //mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(bc.build(), 50),1000,null);
